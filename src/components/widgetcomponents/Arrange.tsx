...
export const Arrange = observer(() => {
  ...
  return (
    <>
   <section onClick={()=>setExpand(!expand)} className={`cursor-pointer font-semibold flex flex-row pl-3 pr-2 justify-between items-center text-xs bg-[#151515]  border-black ${expand===true ? "border-none":"border-b-2"}`}>
          <h3>Arrange</h3>
