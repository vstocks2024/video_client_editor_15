...
export const Stroke =  observer(() => {
  ...
  return (
    <>
    <section onClick={()=>setExpand(!expand)} className={`cursor-pointer max-w-[233px] pl-3 pr-2 font-semibold flex flex-row justify-between items-center text-xs bg-[#151515]  border-black ${expand===true ? "border-none":"border-b-2"}`}>
        <h3>Stroke</h3>
